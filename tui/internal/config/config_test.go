...
`
	...
	want := Config{
		Logo: []string{"AAA", "BBB"},
		Colors: Palette{
			// background/text/selectionBg/selectionText/statusBarBg/
			// statusBarText aren't in the YAML above, so they fall back
			// to Default()'s values — confirming partial-override merge
			// behavior extends to the new fields.
			Background:    "#1a1b26",
			Border:        "red",
			Label:         "blue",
			Text:          "#c0caf5",
