...
1. [ ] Add the JSON/XML body formatter in `internal/snippet`, with focused tests for detection, indentation, unchanged invalid/plain text, and preservation of payload meaning and XML structure.
